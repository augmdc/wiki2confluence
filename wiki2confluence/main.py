    ...
    if wiki_content:
        ...
        if html_content:
            ...
            if markdown_content:
                ...
                # Print the full markdown content for verification
                ...
                if page_id:
                    print(f"Confluence page created or updated with ID: {page_id}")
                else:
                    print("Failed to create or update Confluence page")
            else:
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Convert a wiki page to Markdown and create or update Confluence page")
